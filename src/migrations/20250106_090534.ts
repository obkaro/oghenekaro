...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_hero_social_links_social_link_type" AS ENUM('linkedin', 'email', 'github', 'instagram', 'facebook', 'x');
  CREATE TYPE "public"."enum_pages_hero_social_links_social_link_appearance" AS ENUM('default', 'monochrome');
  ...
  CREATE TYPE "public"."enum_pages_blocks_prose_text_top_margin" AS ENUM('negative', 'regular');
  CREATE TYPE "public"."enum_pages_hero_type" AS ENUM('none', 'highImpact', 'mediumImpact', 'lowImpact');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_version_hero_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_version_hero_links_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum__pages_v_version_hero_social_links_social_link_type" AS ENUM('linkedin', 'email', 'github', 'instagram', 'facebook', 'x');
  CREATE TYPE "public"."enum__pages_v_version_hero_social_links_social_link_appearance" AS ENUM('default', 'monochrome');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_prose_text_top_margin" AS ENUM('negative', 'regular');
  ...
  CREATE TABLE IF NOT EXISTS "pages_hero_social_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"social_link_type" "enum_pages_hero_social_links_social_link_type" DEFAULT 'linkedin',
  	"social_link_appearance" "enum_pages_hero_social_links_social_link_appearance" DEFAULT 'default',
  	"social_link_handle" varchar,
  	"social_link_url" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_prose_text" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"text" jsonb,
  	"top_margin" "enum_pages_blocks_prose_text_top_margin" DEFAULT 'regular',
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "pages_blocks_doings_accordion_doings" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"doing_id" integer
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_doings_accordion" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_version_hero_social_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"social_link_type" "enum__pages_v_version_hero_social_links_social_link_type" DEFAULT 'linkedin',
  	"social_link_appearance" "enum__pages_v_version_hero_social_links_social_link_appearance" DEFAULT 'default',
  	"social_link_handle" varchar,
  	"social_link_url" varchar,
  	"_uuid" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_prose_text" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"text" jsonb,
  	"top_margin" "enum__pages_v_blocks_prose_text_top_margin" DEFAULT 'regular',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_doings_accordion_doings" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"doing_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_doings_accordion" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v" (
  	...
  	"version_hero_kicker" jsonb,
  	"version_hero_hero_text" jsonb,
  ...
  CREATE TABLE IF NOT EXISTS "tags_breadcrumbs" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"doc_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "doings_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_hero_social_links" ADD CONSTRAINT "pages_hero_social_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_prose_text" ADD CONSTRAINT "pages_blocks_prose_text_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_doings_accordion_doings" ADD CONSTRAINT "pages_blocks_doings_accordion_doings_doing_id_doings_id_fk" FOREIGN KEY ("doing_id") REFERENCES "public"."doings"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_doings_accordion_doings" ADD CONSTRAINT "pages_blocks_doings_accordion_doings_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_doings_accordion"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_doings_accordion" ADD CONSTRAINT "pages_blocks_doings_accordion_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_version_hero_social_links" ADD CONSTRAINT "_pages_v_version_hero_social_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_prose_text" ADD CONSTRAINT "_pages_v_blocks_prose_text_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_doings_accordion_doings" ADD CONSTRAINT "_pages_v_blocks_doings_accordion_doings_doing_id_doings_id_fk" FOREIGN KEY ("doing_id") REFERENCES "public"."doings"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_doings_accordion_doings" ADD CONSTRAINT "_pages_v_blocks_doings_accordion_doings_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_doings_accordion"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_doings_accordion" ADD CONSTRAINT "_pages_v_blocks_doings_accordion_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "doings_rels" ADD CONSTRAINT "doings_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."doings"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "doings_rels" ADD CONSTRAINT "doings_rels_tools_fk" FOREIGN KEY ("tools_id") REFERENCES "public"."tools"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_doings_fk" FOREIGN KEY ("doings_id") REFERENCES "public"."doings"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_hero_social_links_order_idx" ON "pages_hero_social_links" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_hero_social_links_parent_id_idx" ON "pages_hero_social_links" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_prose_text_order_idx" ON "pages_blocks_prose_text" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_prose_text_parent_id_idx" ON "pages_blocks_prose_text" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_prose_text_path_idx" ON "pages_blocks_prose_text" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_doings_accordion_doings_order_idx" ON "pages_blocks_doings_accordion_doings" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_doings_accordion_doings_parent_id_idx" ON "pages_blocks_doings_accordion_doings" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_doings_accordion_doings_doing_idx" ON "pages_blocks_doings_accordion_doings" USING btree ("doing_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_doings_accordion_order_idx" ON "pages_blocks_doings_accordion" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_doings_accordion_parent_id_idx" ON "pages_blocks_doings_accordion" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_doings_accordion_path_idx" ON "pages_blocks_doings_accordion" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_version_hero_social_links_order_idx" ON "_pages_v_version_hero_social_links" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_version_hero_social_links_parent_id_idx" ON "_pages_v_version_hero_social_links" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_prose_text_order_idx" ON "_pages_v_blocks_prose_text" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_prose_text_parent_id_idx" ON "_pages_v_blocks_prose_text" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_prose_text_path_idx" ON "_pages_v_blocks_prose_text" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_doings_accordion_doings_order_idx" ON "_pages_v_blocks_doings_accordion_doings" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_doings_accordion_doings_parent_id_idx" ON "_pages_v_blocks_doings_accordion_doings" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_doings_accordion_doings_doing_idx" ON "_pages_v_blocks_doings_accordion_doings" USING btree ("doing_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_doings_accordion_order_idx" ON "_pages_v_blocks_doings_accordion" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_doings_accordion_parent_id_idx" ON "_pages_v_blocks_doings_accordion" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_doings_accordion_path_idx" ON "_pages_v_blocks_doings_accordion" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "tags_breadcrumbs_order_idx" ON "tags_breadcrumbs" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "tags_breadcrumbs_parent_id_idx" ON "tags_breadcrumbs" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "tags_breadcrumbs_doc_idx" ON "tags_breadcrumbs" USING btree ("doc_id");
  CREATE INDEX IF NOT EXISTS "tags_parent_idx" ON "tags" USING btree ("parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "tools_logo_idx" ON "tools" USING btree ("logo_id");
  ...
  CREATE INDEX IF NOT EXISTS "doings_updated_at_idx" ON "doings" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "doings_created_at_idx" ON "doings" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "doings_rels_order_idx" ON "doings_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "doings_rels_parent_idx" ON "doings_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "doings_rels_path_idx" ON "doings_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "doings_rels_tools_id_idx" ON "doings_rels" USING btree ("tools_id");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_doings_id_idx" ON "payload_locked_documents_rels" USING btree ("doings_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_hero_social_links" CASCADE;
  ...
  DROP TABLE "pages_blocks_prose_text" CASCADE;
  DROP TABLE "pages_blocks_doings_accordion_doings" CASCADE;
  DROP TABLE "pages_blocks_doings_accordion" CASCADE;
  DROP TABLE "pages" CASCADE;
  DROP TABLE "pages_rels" CASCADE;
  DROP TABLE "_pages_v_version_hero_links" CASCADE;
  DROP TABLE "_pages_v_version_hero_social_links" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_prose_text" CASCADE;
  DROP TABLE "_pages_v_blocks_doings_accordion_doings" CASCADE;
  DROP TABLE "_pages_v_blocks_doings_accordion" CASCADE;
  ...
  DROP TABLE "doings" CASCADE;
  DROP TABLE "doings_rels" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_hero_social_links_social_link_type";
  DROP TYPE "public"."enum_pages_hero_social_links_social_link_appearance";
  ...
  DROP TYPE "public"."enum_pages_blocks_prose_text_top_margin";
  DROP TYPE "public"."enum_pages_hero_type";
  DROP TYPE "public"."enum_pages_status";
  DROP TYPE "public"."enum__pages_v_version_hero_links_link_type";
  DROP TYPE "public"."enum__pages_v_version_hero_links_link_appearance";
  DROP TYPE "public"."enum__pages_v_version_hero_social_links_social_link_type";
  DROP TYPE "public"."enum__pages_v_version_hero_social_links_social_link_appearance";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_prose_text_top_margin";
